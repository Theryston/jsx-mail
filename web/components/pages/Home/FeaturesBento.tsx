...
export function FeaturesBento({
  ...
  return (
    <section className="relative flex flex-col items-center px-6 py-8 pb-8 font-sans md:pb-24 lg:pb-32 gap-9 lg:gap-14">
      ...
      <div className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2 lg:grid-cols-3 lg:gap-x-6 lg:gap-y-6 max-w-[1200px]">
        {features.map((feature) => (
          ...
          >
            <FeatureBox description={feature.description} name={feature.name} />
          </FadeIn>
        ))}
      </div>
    </section>
