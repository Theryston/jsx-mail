---
title: 'A framework to create the email template'
---
...
{<h1 className="text-center font-extrabold md:text-5xl mt-8">Jsx Mail</h1>}
...
<Bleed>
  <div className="flex items-center justify-center gap-3">
    ...
    <a
      aria-label="License"
      href="https://github.com/Theryston/jsx-mail/blob/master/LICENSE"
    >
      <img
        alt=""
