...
- **`sender`**: You can specify a sender from [your JSX Mail Cloud resources](/cloud/app/resources) to use for sending emails. This is not required if you don't send emails using JSX Mail, if you send you need to set it or hava at least one sender created in your JSX Mail Cloud.
