...
The `<div />` tag is used to create a div in your email. It accepts the following props:

| Prop | Type | Description |
| ---- | ---- | ----------- |
| `alignY` | `string` | The vertical alignment of the div |
| `alignX` | `string` | The horizontal alignment of the div |
| `sectionPending` | `number` | The space between each section inside it |
| `className` | `string` | Some class to the result HTML |
| `id` | `string` | Some ID to the result HTML |
| `style` | `JSX.ElementStyle` | Some style to the result HTML [see more here](/docs/style) |
| `children` | `JSX.ElementChildren` | The div content |
| `container` | `boolean` | If it is a container or not |
| `section` | `boolean` | If it is a section or not |
