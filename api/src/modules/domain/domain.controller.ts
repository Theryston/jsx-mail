...
export class DomainController {
	constructor(private readonly createDomainService: CreateDomainService, private readonly deleteDomainService: DeleteDomainService, private readonly listDomainsService: ListDomainsService) { }
