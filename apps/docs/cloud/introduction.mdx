...
To use JSX Mail Cloud you need to create an account by clicking [here](https://jsxmail.org/cloud/sign-up) and then you can log in to your account via your terminal and even in production

You can access JSX Mail Cloud by [clicking here](https://jsxmail.org/cloud/app)
