---
title: Tags
description: Learn how to use tags with JSX Mail.
icon: 'tag'
---
...
| `style`     | `JSX.ElementStyle`    | Some style to the result HTML [see more here](/framework/style) |
...
The `<img />` tag is used to create an image in your email. See more about it [here](/framework/image).
...
| `src`    | `string`           | The image path [see more](/framework/image)                     |
| `style`  | `JSX.ElementStyle` | Some style to the result HTML [see more here](/framework/style) |
