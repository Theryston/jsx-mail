...
export const MAX_BALANCE_TO_BE_ELIGIBLE_FOR_FREE = 0.5 * MONEY_SCALE; // $0.50 | if the user balance is more then this amount, the user is not eligible for free emails
